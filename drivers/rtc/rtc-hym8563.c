...
static struct i2c_board_info hym8563_i2c_board_info[] __initdata = {
	{
...
static int __init hym8563_init(void)
{
	...
	ret  = i2c_register_board_info(0, hym8563_i2c_board_info, 1);
	
	printk("============ hym8563_init i2c board info register ret = %d=============\n", ret);
